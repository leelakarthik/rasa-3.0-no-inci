...
class ActionShowTemplate(Action):

    def name(self):
        return "action_show_template"
...
class FurtherHelpForm(FormValidationAction):
    """This Form is used to ask further detals"""
    def name(self):
        """Name of the Form"""
        return "further_help_form"


    @staticmethod
    def required_slots(tracker: Tracker) -> List[Text]:
        "We are taking name and problem"
        return ["name","id","problem"]
    ...
    def slot_mappings(self) -> Dict[Text, Union[Dict, List[Dict]]]:
        ...
        return {
            "name": self.from_entity(entity="name", intent="intent_name"),
            "id": self.from_entity(entity="id", intent="intent_id"),
            "problem": self.from_text(intent="intent_problem"),
        }
...
class OpenIncidentForm(FormValidationAction):
    def name(self) -> Text:
